...
export const objectarray: objectarrays[] = [
  {
    type: "Object Arrays",
...
export const arithmetic: arithmetics[] = [
  {
...
export const databinding: databindings[] = [
  {
...
export const exported: exportss[] = [
  {
    type: "Interface",
    explaination: "string",
