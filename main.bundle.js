...
module.exports = "<div class=\"ui-g advance\" style=\"overflow-y:auto;\">\n  <div class=\"ui-g-12 ui-md-12 ui-lg-12\">\n\n    <div class=\"httprequestget\">\n      <h1>Http Request</h1>\n      <p-accordion class=\"Httprequestget\">\n        <p-accordionTab header=\"{{httpg.type}}\" *ngFor=\"let httpg of Httprequestget;let index = index;\">\n          <p class=\"\">{{httpg.explaination}}</p>\n          <p class=\"\">\n            Code:\n          </p>\n          <md-card>\n            {{httpg.code}}<br>\n            <pre class=\"\">{{httpg.furtherexplaination1}}</pre> {{httpg.code2}}<br>\n            <pre class=\"\">{{httpg.furtherexplaination2}}</pre>\n            <p class=\"p-class\">Output</p>\n            <ng-template [ngIf]=\"index == 0\">\n              <md-card>\n                <span mdTooltip=\"Get request to use searching\">\n                  <button md-raised-button (click)=\"getData()\">\n                  Click me to view request\n                  </button>\n                </span>\n                <md-spinner *ngIf=\"spinner\"></md-spinner><br><br>\n                <form class=\"example-form\">\n                  <ng-template [ngIf]=\"click == true\">\n                    <md-input-container class=\"example-full-width\">\n                      <input mdInput placeholder=\"Names\" aria-label=\"Names\" [mdAutocomplete]=\"auto\" [formControl]=\"nameCtrl\">\n                      <md-autocomplete #auto=\"mdAutocomplete\">\n                        <md-option *ngFor=\"let state of filteredStates | async; let index = index;\" [value]=\"state.first_name\">\n                          <img style=\"vertical-align:middle;\" aria-hidden src=\"http://ekmillerlab.mit.edu/wp-content/uploads/2016/04/male-member.jpg\"\n                            height=\"25\" />\n                          <span>{{ state.first_name }} {{state.middle_name}} {{state.last_name}}</span>\n                        </md-option>\n                      </md-autocomplete>\n                    </md-input-container>\n                  </ng-template>\n                </form>\n                <ul class=\"ul-margin\" *ngIf=\"click == true\">\n                  <span class=\"h4\">Users</span>\n                  <li *ngFor=\"let x of filteredStates | async\">\n                    <md-input-container>\n                      <input mdInput placeholder=\"first name\" type=\"text\" class=\"\" [(ngModel)]=\"x.first_name\" required>\n                      <md-error *ngIf=\"textNullControl.hasError('required')\">\n                        First name is <strong>required</strong>\n                      </md-error>\n                    </md-input-container>\n                    <md-input-container>\n                      <input mdInput placeholder=\"middle name\" type=\"text\" class=\"\" [(ngModel)]=\"x.middle_name\" required>\n                      <md-error *ngIf=\"textNullControl.hasError('required')\">\n                        Middle name is <strong>required</strong>\n                      </md-error>\n                    </md-input-container>\n                    <md-input-container>\n                      <input mdInput placeholder=\"last name\" type=\"text\" class=\"\" [(ngModel)]=\"x.last_name\" required>\n                      <md-error *ngIf=\"textNullControl.hasError('required')\">\n                        Last name is <strong>required</strong>\n                      </md-error>\n                    </md-input-container>\n                    <md-input-container>\n                      <input mdInput placeholder=\"location\" type=\"text\" class=\"\" [(ngModel)]=\"x.location\" required>\n                      <md-error *ngIf=\"textNullControl.hasError('required')\">\n                        Location is <strong>required</strong>\n                      </md-error>\n                    </md-input-container>\n                    <md-input-container>\n                      <input mdInput placeholder=\"age\" type=\"number\" class=\"\" [(ngModel)]=\"x.age\" required>\n                      <md-error *ngIf=\"textNullControl.hasError('required')\">\n                        age is <strong>required</strong>\n                      </md-error>\n                    </md-input-container>\n                    <md-input-container>\n                      <input mdInput placeholder=\"email\" type=\"text\" class=\"\" [(ngModel)]=\"x.email\" required>\n                      <md-error *ngIf=\"emailFormControl.hasError('required')\">\n                        Email is <strong>required</strong>\n                      </md-error>\n                    </md-input-container>\n                    <button md-raised-button (click)=\"removeData(x.id,'Data Deleted (i refresh sa ang page kay di pa ni live refresh)','Close')\">remove</button>\n                    <button md-raised-button (click)=\"putData(x.id,x.first_name,x.middle_name,x.last_name,x.location,x.age,x.email,'Data updated','Close')\">update</button>\n                  </li>\n                </ul>\n              </md-card>\n            </ng-template>\n            <ng-template [ngIf]=\"index == 1\">\n              <md-spinner *ngIf=\"postSpinner\"></md-spinner><br><br>\n              <md-input-container>\n                <input type=\"text\" name=\"\" id=\"\" mdInput [(ngModel)]=\"fname\" placeholder=\"First name\" required>\n                <md-error *ngIf=\"textNullControl.hasError('required')\">\n                  First name is <strong>required</strong>\n                </md-error>\n              </md-input-container>\n              <md-input-container>\n                <input type=\"text\" name=\"\" id=\"\" mdInput [(ngModel)]=\"mname\" placeholder=\"Middle name\" required>\n                <md-error *ngIf=\"textNullControl.hasError('required')\">\n                  Middle name is <strong>required</strong>\n                </md-error>\n              </md-input-container>\n              <md-input-container>\n                <input type=\"text\" name=\"\" id=\"\" mdInput [(ngModel)]=\"lname\" placeholder=\"Last name\" required>\n                <md-error *ngIf=\"textNullControl.hasError('required')\">\n                  Last name is <strong>required</strong>\n                </md-error>\n              </md-input-container>\n              <md-input-container>\n                <input type=\"text\" name=\"\" id=\"\" mdInput [(ngModel)]=\"loc\" placeholder=\"Location\" required>\n                <md-error *ngIf=\"textNullControl.hasError('required')\">\n                  Location is <strong>required</strong>\n                </md-error>\n              </md-input-container>\n              <md-input-container>\n                <input type=\"number\" name=\"\" id=\"\" mdInput [(ngModel)]=\"age\" placeholder=\"Age\" pattern=\"[0-9]+\" required>\n                <md-error *ngIf=\"textNullControl.hasError('required')\">\n                  Age is <strong>required</strong>\n                </md-error>\n              </md-input-container>\n              <md-input-container>\n                <input type=\"email\" name=\"\" id=\"\" mdInput [(ngModel)]=\"emailed\" placeholder=\"Email\" required [formControl]=\"emailFormControl\">\n                <md-error *ngIf=\"emailFormControl.hasError('pattern')\">\n                  Please enter a valid email address\n                </md-error>\n                <md-error *ngIf=\"emailFormControl.hasError('required')\">\n                  Email is <strong>required</strong>\n                </md-error>\n              </md-input-container>\n\n              <br> {{fname}}&nbsp;{{mname}}&nbsp;{{lname}}&nbsp;{{loc}}\n\n              <br>\n              <button md-raised-button (click)=\"postData(fname,mname,lname,loc,age,emailed, 'Data stored ','Close')\">Click me to send request</button>\n            </ng-template>\n          </md-card>\n\n\n\n        </p-accordionTab>\n      </p-accordion>\n\n    </div>\n\n    <div class=\"routes\">\n      <h1>Routes</h1>\n      <p-accordion class=\"routes\">\n        <p-accordionTab header=\"{{router.type}}\" *ngFor=\"let router of Routes;let index = index;\">\n          <p class=\"\">{{router.explaination}}</p>\n          <p class=\"\">\n            Code:\n          </p>\n          <md-card>\n            {{router.code}}<br>\n            <pre class=\"\">{{router.furtherexplaination1}}</pre> {{router.code2}}\n            <br>\n            <pre class=\"\">{{router.furtherexplaination2}}</pre> {{router.code3}}\n            <br>\n            <pre class=\"\">{{router.furtherexplaination3}}</pre>\n            <p class=\"p-class\">Output</p>\n            <ng-template [ngIf]=\"index == 0\">\n              <md-card>\n                Ang output is naa na sa screen mismo. Kanang basic and advance na naa sa akong side menu\n              </md-card>\n            </ng-template>\n          </md-card>\n\n        </p-accordionTab>\n      </p-accordion>\n    </div>\n\n    <div class=\"ngmodules\">\n      <h1>NgModules</h1>\n      <p-accordion class=\"ngmodules\">\n        <p-accordionTab header=\"{{ngmod.type}}\" *ngFor=\"let ngmod of Ngmodules;let index = index;\">\n          <p class=\"\">{{ngmod.explaination}}</p>\n          <p class=\"\">\n            Code:\n          </p>\n          <md-card>\n            {{ngmod.code}}<br>\n            <pre class=\"\">{{ngmod.furtherexplaination1}}</pre> {{ngmod.code2}}\n            <br>\n            <pre class=\"\">{{ngmod.furtherexplaination2}}</pre>\n            <p class=\"p-class\">Output</p>\n            <ng-template [ngIf]=\"index == 0\">\n              <md-card>\n                {{ngmod.soutput}}\n              </md-card>\n            </ng-template>\n            <ng-template [ngIf]=\"index == 1\">\n              <md-card>\n                {{ngmod.soutput}}\n              </md-card>\n            </ng-template>\n            <ng-template [ngIf]=\"index == 2\">\n              <md-card>\n                {{ngmod.soutput}}\n              </md-card>\n            </ng-template>\n          </md-card>\n\n        </p-accordionTab>\n      </p-accordion>\n    </div>\n\n    <div class=\"templating\">\n      <h1>Templating</h1>\n      <p-accordion class=\"templating\">\n        <p-accordionTab header=\"{{temp.type}}\" *ngFor=\"let temp of Template;let index = index;\">\n          <p class=\"\">{{temp.explaination}}</p>\n          <p class=\"\">\n            Code:\n          </p>\n          <md-card>\n            {{temp.code}}<br>\n            <pre class=\"\">{{temp.furtherexplaination1}}</pre>\n            <p class=\"p-class\">Output</p>\n            <ng-template [ngIf]=\"index == 0\">\n              <md-card>\n                {{temp.soutput}}\n              </md-card>\n            </ng-template>\n            <ng-template [ngIf]=\"index == 1\">\n              <md-card>\n                {{temp.soutput}}\n              </md-card>\n            </ng-template>\n\n          </md-card>\n\n        </p-accordionTab>\n      </p-accordion>\n    </div>\n\n    <div class=\"styling\">\n      <h1>Style</h1>\n      <p-accordion class=\"style\">\n        <p-accordionTab header=\"{{styl.type}}\" *ngFor=\"let styl of Style;let index = index;\">\n          <p class=\"\">{{styl.explaination}}</p>\n          <p class=\"\">\n            Code:\n          </p>\n          <md-card>\n            {{styl.code}}<br>\n            <pre class=\"\">{{styl.furtherexplaination1}}</pre>\n            <p class=\"p-class\">Output</p>\n            <ng-template [ngIf]=\"index == 0\">\n              <md-card>\n                {{styl.soutput}}\n              </md-card>\n            </ng-template>\n            <ng-template [ngIf]=\"index == 1\">\n              <md-card>\n                {{styl.soutput}}\n              </md-card>\n            </ng-template>\n          </md-card>\n\n        </p-accordionTab>\n      </p-accordion>\n    </div>\n\n\n  </div>\n</div>\n"
...
var AdvanceComponent = (function () {
    function AdvanceComponent(http, snackBar) {
        ...
        this.path = 'https://my-rest-api-postgre.herokuapp.com';
        this.spinner = false;
        this.click = false;
    ...
    AdvanceComponent.prototype.ngOnInit = function () {
        ...
        this.textNullControl = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormControl"]('', [
            __WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].required
        ]);
    };
    //methods
    AdvanceComponent.prototype.filterStates = function (first_name) {
        return this.getDataObject.filter(function (state) {
            return state.first_name.toLowerCase().indexOf(first_name.toLowerCase()) === 0;
        });
    };
    AdvanceComponent.prototype.getData = function () {
        var _this = this;
        this.spinner = true;
        this.http.get(this.path + '/info/personal/').subscribe(function (data) {
            _this.click = true;
            _this.getDataObject = data['results'];
            _this.filteredStates = _this.nameCtrl.valueChanges
                .startWith(null)
                .map(function (state) { return state ? _this.filterStates(state) : _this.getDataObject.slice(); });
            _this.spinner = false;
        }), function (err) {
    ...
    AdvanceComponent.prototype.postData = function (fname, mname, lname, loc, age, email, message, action) {
        var _this = this;
        this.postSpinner = true;
        var body = { first_name: fname, middle_name: mname, last_name: lname, location: loc, age: age, email: email };
        this.http
    ...
    AdvanceComponent.prototype.removeData = function (id, message, action) {
        ...
        this.http.delete(this.path + '/info/personal/' + pk + '/', options).subscribe(function (data) {
            _this.spinner = false;
            _this.snackBar.open(message, action, {
                duration: 3000,
            });
...
AdvanceComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpClient */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpClient */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_material__["j" /* MdSnackBar */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_material__["j" /* MdSnackBar */]) === "function" && _b || Object])
], AdvanceComponent);
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_10__angular_material__["i" /* MdAutocompleteModule */]
        ],
        providers: [],
...
], BasicsComponent.prototype, "Declaration", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], BasicsComponent.prototype, "Condition", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], BasicsComponent.prototype, "Parsing", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], BasicsComponent.prototype, "Array", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], BasicsComponent.prototype, "Object", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], BasicsComponent.prototype, "Objectarray", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], BasicsComponent.prototype, "Loops", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], BasicsComponent.prototype, "Func", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], BasicsComponent.prototype, "Arithmetic", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], BasicsComponent.prototype, "Databinding", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], BasicsComponent.prototype, "Export", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], BasicsComponent.prototype, "Event", void 0);
